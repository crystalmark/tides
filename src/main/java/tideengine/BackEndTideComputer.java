...
public class BackEndTideComputer {
    ...
    public static InputSource getZipInputSource(String filename, String entryName) throws Exception {
        InputStream zipStream = BackEndXMLTideComputer.class.getResourceAsStream(filename);
        ...
        if (is == null) {
            throw new RuntimeException("Entry " + entryName + " not found in " + filename.toString());
        }
        return is;
    }
